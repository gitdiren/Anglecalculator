...
#booking= Label(titleframe, text="Booking info").grid(row=12, column=0,sticky ="w", padx="20")
#bookings= Entry(titleframe, text= "%s" %(summ)).grid(row=12, column=1,sticky ="w", padx="20")
